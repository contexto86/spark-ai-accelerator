...
- `knowledge/module_03/13_reading_execution_plans.md`
- `knowledge/module_03/14_common_antipatterns.md`

## Guided Exercises

- `exercises/module_03/exercise_08_explain_dataframe_plan.md`
