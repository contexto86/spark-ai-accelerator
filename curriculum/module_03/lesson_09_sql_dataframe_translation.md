...
- `knowledge/module_03/01_dataframes_vs_sql.md`
- `knowledge/module_03/15_interview_notes.md`

## Guided Exercises

- `exercises/module_03/exercise_09_sql_dataframe_translation_workbook.md`
